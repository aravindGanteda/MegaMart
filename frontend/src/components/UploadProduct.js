...
const UploadProduct = (props) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-slate-200 bg-opacity-50 w-full h-full flex justify-center items-center ">
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
        ...
        >
          ...
          <textarea
            ...
            required
          ></textarea>
          <button disabled = {submitLoading} className="px-3 disabled:opacity-60 disabled:cursor-not-allowed py-2 bg-red-600 text-white mb-10 hover:bg-red-700 rounded ">
            Upload Product
          </button>
        </form>
      </div>
